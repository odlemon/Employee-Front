...
import { useCreateDepartmentMutation } from "../redux/slices/api/departmentApiSlice";
import { toast } from "sonner";

const AddDepartment = ({ open, setOpen, branchId, refetch }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      await createDepartment({ name, description, branchId }).unwrap();
  ...
  return (
    <ModalWrapper open={open} setOpen={setOpen} title="Add New Department">
