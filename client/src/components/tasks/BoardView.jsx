...
const BoardView = ({ tasks, selectedDepartment, status }) => {
  ...
  // Define the columns to display based on status
  const columnsToDisplay = ["todo", "in progress", "completed"].includes(status)
    ? [status] // Show only the column that matches the status
