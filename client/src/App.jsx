...
import { Dashboard, Login, TaskDetail, Tasks, Trash, Users, Organization, Overview } from "./pages";
...
const App = () => {
  ...
  return (
    <main className={theme}>
      <div className='w-full min-h-screen bg-[#f3f4f6] dark:bg-[#0d0d0df4] flex flex-col'>
        ...
        {/* Footer */}
        <footer className="w-full py-4 bg-gray-200 dark:bg-[#1f1f1f] text-center">
